...
st.title("Trade information")
# @TODO:
# Add an input area where you can get a value for `sender` from the user.
in_sender= st.text_input("Sender ID")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
in_receiver= st.text_input("Receiver ID")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
in_amount= st.text_input("Amount to be transacted")
...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        record= Record(sender=in_sender, receiver=in_receiver, amount=in_amount),
        creator_id=42,
